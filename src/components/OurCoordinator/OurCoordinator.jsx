        ...
        <div className={styles.switch}>
...

            {
                ...
                <div className={styles.box2} data-aos="fade-left">
                    ...
                    <Typography variant="body1" style={{fontWeight: '300'}}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt fugiat laboriosam minus officiis tempore ex nostrum eligendi deserunt modi, cum illo ullam doloremque, recusandae pariatur molestias rerum tenetur eveniet voluptatum.</Typography>
                </div>
                ...
                <div className={styles.box4} data-aos="fade-left">
                    <div className={styles.experienceItems}>
                        ...
                        <Typography variant="body1">Amaravathi</Typography>
                    </div>
                    <div className={showPoints ? `${styles.points} ${styles.show}` : `${styles.points}`}>
                    <div className={styles.experienceItems}>
                        <Typography variant="h5" style={{fontWeight: '400'}}>Professor & HOD</Typography>
                        <Typography variant="body1">Lakireddy Balireddy College Of Engineering</Typography>
                        <Typography variant="body1">Jun 2015 - Apr 2019 · 3 yrs 11 mos</Typography>
                        <Typography variant="body1">Mylavaram, Krishna(District), A.P</Typography>
                    </div>
                    <div className={styles.experienceItems}>
