...
import LOHITHA_RANI_CHINTALAPATI from './Admin_Dept/LOHITHA_RANI_CHINTALAPATI.jpg'
...
const admin = [
    ...
    {
        id: 9,
        tag: 'Doc and Content department-Lead',
        backgroundImage: NERELLA_ADITHYA,
        name: 'NERELLA ADITHYA',
        description: 'Lorem ipsum dolor sit a and amet consectetur adipisicing elit. Consequuntur, ea?',
        facebook: '#',
        instagram: '#',
        linkedin: '#'
    ...
    {
        id: 11,
        tag: 'Admin department- Executive',
